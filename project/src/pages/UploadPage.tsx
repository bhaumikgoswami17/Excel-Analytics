        ...
        <CardContent>
          {isSuccess ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mb-4">Your file has been uploaded successfully. Redirecting to analysis page...</p>
      ...
      <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
        ...
        <ul className="space-y-2 text-gray-700">
          ...
          <li className="flex items-start">
            ...
            For best visualization results, clean your data of any empty rows or columns
          </li>
          <li className="flex items-start">
            <span className="inline-flex items-center justify-center h-5 w-5 rounded-full bg-blue-100 text-blue-600 text-xs font-medium mr-2 mt-0.5">
              3
            </span>
            Files up to 10MB are supported for optimal performance
          </li>
          <li className="flex items-start">
            <span className="inline-flex items-center justify-center h-5 w-5 rounded-full bg-blue-100 text-blue-600 text-xs font-medium mr-2 mt-0.5">
              4
